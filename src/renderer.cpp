...
void Renderer::load_scene(std::uint32_t render_width,
...
void Renderer::write_to_png(const char *file_name) const
{
...
void Renderer::select_physical_device(std::uint32_t device_extension_count,
...
void Renderer::create_device(std::uint32_t device_extension_count,
                             const char *const *device_extension_names)
{
...
Renderer::begin_one_time_submit_command_buffer() const
{
...
void Renderer::end_one_time_submit_command_buffer(
...
void Renderer::create_storage_image(std::uint32_t width, std::uint32_t height)
{
    m_width = width;
    m_height = height;
...
void Renderer::create_geometry_buffer(const std::vector<float> &vertices,
...
Renderer::create_shader_module(const char *file_name) const
{
