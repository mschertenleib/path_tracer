...
constexpr void check_result(VkResult result, const char *message)
{
    if (result != VK_SUCCESS)
    {
        // TODO: include result in exception message
              ...
              VmaAllocationInfo *allocation_info = nullptr)
{
    ...
    return {buffer, Handle_deleter<VkBuffer> {allocator, allocation}};
}

[[nodiscard]] Handle<VkImage>
             ...
             VmaAllocationInfo *allocation_info = nullptr)
{
    ...
    return {image, Handle_deleter<VkImage> {allocator, allocation}};
}
...
void create_ray_tracing_pipeline(Renderer &r)
{
    ...
    check_result(ray_tracing_pipeline.result,
...
void Handle_deleter<VkInstance>::operator()(VkInstance instance) const noexcept
{
...
void Handle_deleter<VkBuffer>::operator()(VkBuffer buffer) const noexcept
{
    vmaDestroyBuffer(allocator, buffer, allocation);
}

void Handle_deleter<VkImage>::operator()(VkImage image) const noexcept
{
